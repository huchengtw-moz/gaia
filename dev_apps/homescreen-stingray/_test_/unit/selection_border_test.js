...
suite('SelectionBorder', function() {
  ...
  suite('single-selection', function() {
    ...
    test('select sampleUI1', function() {
      ...
      assert.equal(selector.selectedItems[0].border.style.left,
                   (100 + borderContainerBounding.x) + 'px');
      assert.equal(selector.selectedItems[0].border.style.top,
                   (100 + borderContainerBounding.y) + 'px');
    ...
    test('select sampleUI1 and sampleUI2', function() {
      ...
      assert.equal(selector.selectedItems[0].border.style.left,
                   (500 + borderContainerBounding.x) + 'px');
      assert.equal(selector.selectedItems[0].border.style.top,
                   (500 + borderContainerBounding.y) + 'px');
  ...
  suite('multiple-selection', function() {
    ...
    test('select sampleUI1 and sampleUI2', function() {
      ...
      assert.equal(selector.selectedItems[1].border.style.left,
                   (500 + borderContainerBounding.x) + 'px');
      assert.equal(selector.selectedItems[1].border.style.top,
                   (500 + borderContainerBounding.y) + 'px');
